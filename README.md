...
各工程の待ち時間には、ドット絵のループアニメ「真夜中の醸造所」シリーズが流れます([PixelForge](https://github.com/FUJIvillage/pixelforge)で制作。仕込み=マッシュ桶、煮沸=沸騰ケトル、レシピ生成=羽ペンの机、デザイン=イーゼル、タップビルド=醸造ケトル、熟成=砂時計。Pub は専用のバーVN演出があるため対象外)。
